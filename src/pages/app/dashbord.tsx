    ...
    return (
        <div className="grid grid-cols-2 py-4">
            <div className="justify-center flex">
                <div className="flex flex-col items-center w-[12rem] h-[13rem] bg-muted-foreground/50 rounded-lg justify-around">
            ...
            <div className='grid grid-cols-2 gap-4'>
                <div className="flex flex-col justify-center items-center bg-muted-foreground/50 w-[12rem] h-[6rem] rounded-lg text-primary gap-2">
